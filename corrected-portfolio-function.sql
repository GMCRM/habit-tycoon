-- CORRECTED portfolio function with proper business names and owner names
...
SELECT gen_random_uuid() as holding_id,
    ...
    -- Get actual user name from user_profiles
...
FROM user_holdings uh
    ...
    LEFT JOIN user_profiles up ON bs.business_owner_id = up.id -- Get owner names
