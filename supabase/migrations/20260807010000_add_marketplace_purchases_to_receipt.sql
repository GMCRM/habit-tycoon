-- get_weekly_receipt() itemizes habit_completions, stock_dividend_distributions,
-- stock_transactions, and business_sales, but the Marketplace feature
-- (20260724060100_marketplace_functions.sql) added a fifth cash-moving event —
-- buying a listing writes to marketplace_purchases and debits the buyer's cash
-- via adjust_user_cash() — without ever adding it to this ledger. As a result
-- Marketplace purchases never appeared on the Receipts page.
