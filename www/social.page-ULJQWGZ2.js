...
function SocialPage_ion_button_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function SocialPage_ion_button_4_Template_ion_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
...
function SocialPage_ion_button_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "ion-button", 21);
    \u0275\u0275listener("click", function SocialPage_ion_button_6_Template_ion_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
function SocialPage_div_11_ion_badge_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-badge", 36);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function SocialPage_div_11_div_15_div_7_ion_card_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "ion-card", 44)(1, "ion-card-content")(2, "div", 45)(3, "div", 46)(4, "h3");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "ion-button", 47);
    \u0275\u0275listener("click", function SocialPage_div_11_div_15_div_7_ion_card_1_Template_ion_button_click_6_listener() {
      const friend_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.removeFriend(friend_r7));
    });
    \u0275\u0275element(7, "ion-icon", 48);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const friend_r7 = ctx.$implicit;
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(friend_r7.friend_profile == null ? null : friend_r7.friend_profile.name);
  }
}
function SocialPage_div_11_div_15_div_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 42);
    \u0275\u0275template(1, SocialPage_div_11_div_15_div_7_ion_card_1_Template, 8, 1, "ion-card", 43);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function SocialPage_div_11_div_15_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "ion-button", 39);
    \u0275\u0275listener("click", function SocialPage_div_11_div_15_ng_template_8_Template_ion_button_click_6_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.addFriend());
    });
    \u0275\u0275element(7, "ion-icon", 40);
    \u0275\u0275text(8, " Add Your First Friend ");
    \u0275\u0275elementEnd()();
  }
}
function SocialPage_div_11_div_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 37)(1, "div", 38)(2, "h2");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "ion-button", 39);
    \u0275\u0275listener("click", function SocialPage_div_11_div_15_Template_ion_button_click_4_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.addFriend());
    });
    \u0275\u0275element(5, "ion-icon", 40);
    \u0275\u0275text(6, " Add Friend ");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(7, SocialPage_div_11_div_15_div_7_Template, 2, 1, "div", 41)(8, SocialPage_div_11_div_15_ng_template_8_Template, 9, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const noFriends_r9 = \u0275\u0275reference(9);
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", ctx_r1.friends.length, " Friends");
    \u0275\u0275advance(4);
    \u0275\u0275property("ngIf", ctx_r1.friends.length > 0)("ngIfElse", noFriends_r9);
  }
}
function SocialPage_div_11_div_16_ion_button_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "ion-button", 55);
    \u0275\u0275listener("click", function SocialPage_div_11_div_16_ion_button_4_Template_ion_button_click_0_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r1 = \u0275\u0275nextContext(3);
...
function SocialPage_div_11_div_16_div_5_ion_card_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "ion-card", 60)(1, "ion-card-content")(2, "div", 61)(3, "div", 62)(4, "h4");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(9);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "div", 65)(11, "ion-button", 66);
    \u0275\u0275listener("click", function SocialPage_div_11_div_16_div_5_ion_card_4_Template_ion_button_click_11_listener() {
      const request_r12 = \u0275\u0275restoreView(_r11).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.acceptRequest(request_r12.id));
    });
    \u0275\u0275element(12, "ion-icon", 67);
    \u0275\u0275text(13, " Accept ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "ion-button", 68);
    \u0275\u0275listener("click", function SocialPage_div_11_div_16_div_5_ion_card_4_Template_ion_button_click_14_listener() {
      const request_r12 = \u0275\u0275restoreView(_r11).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.declineRequest(request_r12.id));
    });
    \u0275\u0275element(15, "ion-icon", 69);
    \u0275\u0275text(16, " Decline ");
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", (request_r12.sender_profile == null ? null : request_r12.sender_profile.name) || "Unknown User", " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", request_r12.sender_profile == null ? null : request_r12.sender_profile.email, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.formatTimeAgo(request_r12.created_at), " ");
  }
}
function SocialPage_div_11_div_16_div_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 56)(1, "h3", 57);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 58);
    \u0275\u0275template(4, SocialPage_div_11_div_16_div_5_ion_card_4_Template, 17, 3, "ion-card", 59);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function SocialPage_div_11_div_16_div_6_ion_card_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-card", 60)(1, "ion-card-content")(2, "div", 61)(3, "div", 62)(4, "h4");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", (request_r13.recipient_profile == null ? null : request_r13.recipient_profile.name) || "Unknown User", " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", request_r13.recipient_profile == null ? null : request_r13.recipient_profile.email, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" Pending since ", ctx_r1.formatTimeAgo(request_r13.created_at), " ");
  }
}
function SocialPage_div_11_div_16_div_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 56)(1, "h3", 57);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 58);
    \u0275\u0275template(4, SocialPage_div_11_div_16_div_6_ion_card_4_Template, 10, 3, "ion-card", 59);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function SocialPage_div_11_div_16_div_7_ion_card_1_span_4_Template(rf, ctx) {
  if (rf & 1) {
...
function SocialPage_div_11_div_16_div_7_ion_card_1_span_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "\u{1F4C8}");
    \u0275\u0275elementEnd();
...
function SocialPage_div_11_div_16_div_7_ion_card_1_ng_container_6_span_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "\u{1F525}");
    \u0275\u0275elementEnd();
...
function SocialPage_div_11_div_16_div_7_ion_card_1_ng_container_6_span_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "\u{1F3C6}");
    \u0275\u0275elementEnd();
...
function SocialPage_div_11_div_16_div_7_ion_card_1_ng_container_6_span_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "\u{1F48E}");
    \u0275\u0275elementEnd();
...
function SocialPage_div_11_div_16_div_7_ion_card_1_ng_container_6_span_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "\u2B50");
    \u0275\u0275elementEnd();
...
function SocialPage_div_11_div_16_div_7_ion_card_1_ng_container_6_span_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "\u{1F31F}");
    \u0275\u0275elementEnd();
...
function SocialPage_div_11_div_16_div_7_ion_card_1_ng_container_6_span_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "\u{1F3AF}");
    \u0275\u0275elementEnd();
...
function SocialPage_div_11_div_16_div_7_ion_card_1_ng_container_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, SocialPage_div_11_div_16_div_7_ion_card_1_ng_container_6_span_1_Template, 2, 0, "span", 14)(2, SocialPage_div_11_div_16_div_7_ion_card_1_ng_container_6_span_2_Template, 2, 0, "span", 14)(3, SocialPage_div_11_div_16_div_7_ion_card_1_ng_container_6_span_3_Template, 2, 0, "span", 14)(4, SocialPage_div_11_div_16_div_7_ion_card_1_ng_container_6_span_4_Template, 2, 0, "span", 14)(5, SocialPage_div_11_div_16_div_7_ion_card_1_ng_container_6_span_5_Template, 2, 0, "span", 14)(6, SocialPage_div_11_div_16_div_7_ion_card_1_ng_container_6_span_6_Template, 2, 0, "span", 14);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const notification_r15 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (notification_r15.metadata == null ? null : notification_r15.metadata.milestone_key) === "streak_7");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (notification_r15.metadata == null ? null : notification_r15.metadata.milestone_key) === "streak_30");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (notification_r15.metadata == null ? null : notification_r15.metadata.milestone_key) === "streak_100");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (notification_r15.metadata == null ? null : notification_r15.metadata.milestone_key) === "completions_10");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (notification_r15.metadata == null ? null : notification_r15.metadata.milestone_key) === "completions_50");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (notification_r15.metadata == null ? null : notification_r15.metadata.milestone_key) === "completions_100");
  }
}
function SocialPage_div_11_div_16_div_7_ion_card_1_span_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "\u{1F514}");
    \u0275\u0275elementEnd();
...
function SocialPage_div_11_div_16_div_7_ion_card_1_ion_badge_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-badge", 82);
    \u0275\u0275text(1, " New ");
    \u0275\u0275elementEnd();
  }
}
function SocialPage_div_11_div_16_div_7_ion_card_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r14 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "ion-card", 73)(1, "ion-card-content")(2, "div", 74)(3, "div", 75);
    \u0275\u0275template(4, SocialPage_div_11_div_16_div_7_ion_card_1_span_4_Template, 2, 0, "span", 14)(5, SocialPage_div_11_div_16_div_7_ion_card_1_span_5_Template, 2, 0, "span", 14)(6, SocialPage_div_11_div_16_div_7_ion_card_1_ng_container_6_Template, 7, 6, "ng-container", 14)(7, SocialPage_div_11_div_16_div_7_ion_card_1_span_7_Template, 2, 0, "span", 14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 76);
    \u0275\u0275listener("click", function SocialPage_div_11_div_16_div_7_ion_card_1_Template_div_click_8_listener() {
      const notification_r15 = \u0275\u0275restoreView(_r14).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.markNotificationAsRead(notification_r15.id));
    });
    \u0275\u0275elementStart(9, "div", 77)(10, "p", 78);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    \u0275\u0275template(12, SocialPage_div_11_div_16_div_7_ion_card_1_ion_badge_12_Template, 2, 0, "ion-badge", 79);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "p", 80);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "div", 81)(16, "ion-button", 47);
    \u0275\u0275listener("click", function SocialPage_div_11_div_16_div_7_ion_card_1_Template_ion_button_click_16_listener() {
      const notification_r15 = \u0275\u0275restoreView(_r14).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.deleteNotification(notification_r15.id));
    });
    \u0275\u0275element(17, "ion-icon", 48);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    const notification_r15 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275classProp("unread", !notification_r15.is_read);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngIf", notification_r15.type === "habit_reminder");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", notification_r15.type === "stockholder_reminder");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", notification_r15.type === "friend_milestone");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !notification_r15.type || notification_r15.type !== "habit_reminder" && notification_r15.type !== "stockholder_reminder" && notification_r15.type !== "friend_milestone");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", notification_r15.message, " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !notification_r15.is_read);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.formatTimeAgo(notification_r15.created_at), " ");
  }
}
function SocialPage_div_11_div_16_div_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 71);
    \u0275\u0275template(1, SocialPage_div_11_div_16_div_7_ion_card_1_Template, 18, 9, "ion-card", 72);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function SocialPage_div_11_div_16_ng_template_8_div_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 49);
...
function SocialPage_div_11_div_16_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, SocialPage_div_11_div_16_ng_template_8_div_0_Template, 6, 0, "div", 83);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function SocialPage_div_11_div_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 50)(1, "div", 51)(2, "h2");
    \u0275\u0275text(3, "\u{1F514} Notifications");
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, SocialPage_div_11_div_16_ion_button_4_Template, 2, 0, "ion-button", 52);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, SocialPage_div_11_div_16_div_5_Template, 5, 2, "div", 53)(6, SocialPage_div_11_div_16_div_6_Template, 5, 2, "div", 53)(7, SocialPage_div_11_div_16_div_7_Template, 2, 1, "div", 54)(8, SocialPage_div_11_div_16_ng_template_8_Template, 1, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const noNotifications_r16 = \u0275\u0275reference(9);
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.notifications.length > 0)("ngIfElse", noNotifications_r16);
  }
}
function SocialPage_div_11_div_17_ng_container_9_ion_card_1_div_2_span_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "\u{1F947}");
    \u0275\u0275elementEnd();
...
function SocialPage_div_11_div_17_ng_container_9_ion_card_1_div_2_span_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "\u{1F948}");
    \u0275\u0275elementEnd();
...
function SocialPage_div_11_div_17_ng_container_9_ion_card_1_div_2_span_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "\u{1F949}");
    \u0275\u0275elementEnd();
...
function SocialPage_div_11_div_17_ng_container_9_ion_card_1_div_2_span_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("#", user_r18.rank);
  }
}
function SocialPage_div_11_div_17_ng_container_9_ion_card_1_div_2_div_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 96);
  }
}
function SocialPage_div_11_div_17_ng_container_9_ion_card_1_div_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 91)(1, "div", 92);
    \u0275\u0275template(2, SocialPage_div_11_div_17_ng_container_9_ion_card_1_div_2_span_2_Template, 2, 0, "span", 14)(3, SocialPage_div_11_div_17_ng_container_9_ion_card_1_div_2_span_3_Template, 2, 0, "span", 14)(4, SocialPage_div_11_div_17_ng_container_9_ion_card_1_div_2_span_4_Template, 2, 0, "span", 14)(5, SocialPage_div_11_div_17_ng_container_9_ion_card_1_div_2_span_5_Template, 2, 1, "span", 14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 93)(7, "h3");
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(11, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(12, SocialPage_div_11_div_17_ng_container_9_ion_card_1_div_2_div_12_Template, 1, 0, "div", 95);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const user_r18 = ctx.$implicit;
    const last_r19 = ctx.last;
    \u0275\u0275classProp("current-user", user_r18.name === "You");
    \u0275\u0275advance();
    \u0275\u0275classProp("top-three", user_r18.rank <= 3);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", user_r18.rank === 1);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", user_r18.rank === 2);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", user_r18.rank === 3);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", user_r18.rank > 3);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(user_r18.name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" Net Worth: $", \u0275\u0275pipeBind2(11, 11, user_r18.net_worth || 0, "1.2-2"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", !last_r19);
  }
}
function SocialPage_div_11_div_17_ng_container_9_ion_card_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-card", 89)(1, "ion-card-content");
    \u0275\u0275template(2, SocialPage_div_11_div_17_ng_container_9_ion_card_1_div_2_Template, 13, 14, "div", 90);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(4);
...
function SocialPage_div_11_div_17_ng_container_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, SocialPage_div_11_div_17_ng_container_9_ion_card_1_Template, 3, 1, "ion-card", 88);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    \u0275\u0275nextContext();
    const noLeaderboard_r20 = \u0275\u0275reference(12);
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.friendsLeaderboard.length > 0)("ngIfElse", noLeaderboard_r20);
  }
}
function SocialPage_div_11_div_17_ng_container_10_ng_container_10_div_1_Template(rf, ctx) {
  if (rf & 1) {
...
function SocialPage_div_11_div_17_ng_container_10_ng_container_10_ion_card_2_div_2_span_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "\u{1F947}");
    \u0275\u0275elementEnd();
...
function SocialPage_div_11_div_17_ng_container_10_ng_container_10_ion_card_2_div_2_span_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "\u{1F948}");
    \u0275\u0275elementEnd();
...
function SocialPage_div_11_div_17_ng_container_10_ng_container_10_ion_card_2_div_2_span_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "\u{1F949}");
    \u0275\u0275elementEnd();
...
function SocialPage_div_11_div_17_ng_container_10_ng_container_10_ion_card_2_div_2_span_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("#", user_r22.rank);
  }
}
function SocialPage_div_11_div_17_ng_container_10_ng_container_10_ion_card_2_div_2_div_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 96);
  }
}
function SocialPage_div_11_div_17_ng_container_10_ng_container_10_ion_card_2_div_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 91)(1, "div", 92);
    \u0275\u0275template(2, SocialPage_div_11_div_17_ng_container_10_ng_container_10_ion_card_2_div_2_span_2_Template, 2, 0, "span", 14)(3, SocialPage_div_11_div_17_ng_container_10_ng_container_10_ion_card_2_div_2_span_3_Template, 2, 0, "span", 14)(4, SocialPage_div_11_div_17_ng_container_10_ng_container_10_ion_card_2_div_2_span_4_Template, 2, 0, "span", 14)(5, SocialPage_div_11_div_17_ng_container_10_ng_container_10_ion_card_2_div_2_span_5_Template, 2, 1, "span", 14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 93)(7, "h3");
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(11, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(12, SocialPage_div_11_div_17_ng_container_10_ng_container_10_ion_card_2_div_2_div_12_Template, 1, 0, "div", 95);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const user_r22 = ctx.$implicit;
    const last_r23 = ctx.last;
    \u0275\u0275classProp("current-user", user_r22.name === "You");
    \u0275\u0275advance();
    \u0275\u0275classProp("top-three", user_r22.rank <= 3);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", user_r22.rank === 1);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", user_r22.rank === 2);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", user_r22.rank === 3);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", user_r22.rank > 3);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(user_r22.name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" Earned: $", \u0275\u0275pipeBind2(11, 11, user_r22.cash_earned, "1.2-2"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", !last_r23);
  }
}
function SocialPage_div_11_div_17_ng_container_10_ng_container_10_ion_card_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-card", 89)(1, "ion-card-content");
    \u0275\u0275template(2, SocialPage_div_11_div_17_ng_container_10_ng_container_10_ion_card_2_div_2_Template, 13, 14, "div", 90);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function SocialPage_div_11_div_17_ng_container_10_ng_container_10_ng_template_3_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "ion-button", 39);
    \u0275\u0275listener("click", function SocialPage_div_11_div_17_ng_container_10_ng_container_10_ng_template_3_div_0_Template_ion_button_click_6_listener() {
      \u0275\u0275restoreView(_r24);
...
function SocialPage_div_11_div_17_ng_container_10_ng_container_10_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, SocialPage_div_11_div_17_ng_container_10_ng_container_10_ng_template_3_div_0_Template, 9, 0, "div", 83);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(5);
...
function SocialPage_div_11_div_17_ng_container_10_ng_container_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, SocialPage_div_11_div_17_ng_container_10_ng_container_10_div_1_Template, 2, 0, "div", 101)(2, SocialPage_div_11_div_17_ng_container_10_ng_container_10_ion_card_2_Template, 3, 1, "ion-card", 88)(3, SocialPage_div_11_div_17_ng_container_10_ng_container_10_ng_template_3_Template, 1, 1, "ng-template", null, 3, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const noCashLeaderboard_r25 = \u0275\u0275reference(4);
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.isLoadingCash);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r1.isLoadingCash && ctx_r1.cashLeaderboard.length > 0)("ngIfElse", noCashLeaderboard_r25);
  }
}
function SocialPage_div_11_div_17_ng_container_10_ng_container_11_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 102);
    \u0275\u0275element(1, "ion-spinner", 24);
    \u0275\u0275elementEnd();
...
function SocialPage_div_11_div_17_ng_container_10_ng_container_11_ion_card_2_div_2_span_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "\u{1F947}");
    \u0275\u0275elementEnd();
...
function SocialPage_div_11_div_17_ng_container_10_ng_container_11_ion_card_2_div_2_span_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "\u{1F948}");
    \u0275\u0275elementEnd();
...
function SocialPage_div_11_div_17_ng_container_10_ng_container_11_ion_card_2_div_2_span_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "\u{1F949}");
    \u0275\u0275elementEnd();
...
function SocialPage_div_11_div_17_ng_container_10_ng_container_11_ion_card_2_div_2_span_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const user_r26 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("#", user_r26.rank);
  }
}
function SocialPage_div_11_div_17_ng_container_10_ng_container_11_ion_card_2_div_2_div_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 96);
  }
}
function SocialPage_div_11_div_17_ng_container_10_ng_container_11_ion_card_2_div_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 91)(1, "div", 92);
    \u0275\u0275template(2, SocialPage_div_11_div_17_ng_container_10_ng_container_11_ion_card_2_div_2_span_2_Template, 2, 0, "span", 14)(3, SocialPage_div_11_div_17_ng_container_10_ng_container_11_ion_card_2_div_2_span_3_Template, 2, 0, "span", 14)(4, SocialPage_div_11_div_17_ng_container_10_ng_container_11_ion_card_2_div_2_span_4_Template, 2, 0, "span", 14)(5, SocialPage_div_11_div_17_ng_container_10_ng_container_11_ion_card_2_div_2_span_5_Template, 2, 1, "span", 14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 93)(7, "h3");
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(11, SocialPage_div_11_div_17_ng_container_10_ng_container_11_ion_card_2_div_2_div_11_Template, 1, 0, "div", 95);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const user_r26 = ctx.$implicit;
    const last_r27 = ctx.last;
    \u0275\u0275classProp("current-user", user_r26.name === "You");
    \u0275\u0275advance();
    \u0275\u0275classProp("top-three", user_r26.rank <= 3);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", user_r26.rank === 1);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", user_r26.rank === 2);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", user_r26.rank === 3);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", user_r26.rank > 3);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(user_r26.name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" Completed: ", user_r26.habits_completed, " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !last_r27);
  }
}
function SocialPage_div_11_div_17_ng_container_10_ng_container_11_ion_card_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-card", 89)(1, "ion-card-content");
    \u0275\u0275template(2, SocialPage_div_11_div_17_ng_container_10_ng_container_11_ion_card_2_div_2_Template, 12, 11, "div", 90);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(5);
...
function SocialPage_div_11_div_17_ng_container_10_ng_container_11_ng_template_3_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "ion-button", 39);
    \u0275\u0275listener("click", function SocialPage_div_11_div_17_ng_container_10_ng_container_11_ng_template_3_div_0_Template_ion_button_click_6_listener() {
      \u0275\u0275restoreView(_r28);
      const ctx_r1 = \u0275\u0275nextContext(6);
      return \u0275\u0275resetView(ctx_r1.selectedSegment = "friends");
    });
...
function SocialPage_div_11_div_17_ng_container_10_ng_container_11_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, SocialPage_div_11_div_17_ng_container_10_ng_container_11_ng_template_3_div_0_Template, 9, 0, "div", 83);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(5);
...
function SocialPage_div_11_div_17_ng_container_10_ng_container_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, SocialPage_div_11_div_17_ng_container_10_ng_container_11_div_1_Template, 2, 0, "div", 101)(2, SocialPage_div_11_div_17_ng_container_10_ng_container_11_ion_card_2_Template, 3, 1, "ion-card", 88)(3, SocialPage_div_11_div_17_ng_container_10_ng_container_11_ng_template_3_Template, 1, 1, "ng-template", null, 4, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const noCompletedLeaderboard_r29 = \u0275\u0275reference(4);
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.isLoadingCompleted);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r1.isLoadingCompleted && ctx_r1.completedLeaderboard.length > 0)("ngIfElse", noCompletedLeaderboard_r29);
  }
}
function SocialPage_div_11_div_17_ng_container_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r21 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "p", 97);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "ion-segment", 98);
    \u0275\u0275listener("ionChange", function SocialPage_div_11_div_17_ng_container_10_Template_ion_segment_ionChange_3_listener($event) {
      \u0275\u0275restoreView(_r21);
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.onCashMetricChange($event));
    });
    \u0275\u0275elementStart(4, "ion-segment-button", 99)(5, "ion-label");
    \u0275\u0275text(6, "Weekly Cash");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "ion-segment-button", 100)(8, "ion-label");
    \u0275\u0275text(9, "Weekly Habits");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(10, SocialPage_div_11_div_17_ng_container_10_ng_container_10_Template, 5, 3, "ng-container", 14)(11, SocialPage_div_11_div_17_ng_container_10_ng_container_11_Template, 5, 3, "ng-container", 14);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function SocialPage_div_11_div_17_ng_template_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "ion-button", 39);
    \u0275\u0275listener("click", function SocialPage_div_11_div_17_ng_template_11_Template_ion_button_click_6_listener() {
      \u0275\u0275restoreView(_r30);
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.selectedSegment = "friends");
    });
...
function SocialPage_div_11_div_17_Template(rf, ctx) {
  if (rf & 1) {
    const _r17 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 84)(1, "div", 85)(2, "h2");
    \u0275\u0275text(3, "\u{1F3C6} Friends Leaderboard");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "div", 86)(5, "button", 87);
    \u0275\u0275listener("click", function SocialPage_div_11_div_17_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r17);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function SocialPage_div_11_div_17_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r17);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(9, SocialPage_div_11_div_17_ng_container_9_Template, 2, 2, "ng-container", 14)(10, SocialPage_div_11_div_17_ng_container_10_Template, 12, 4, "ng-container", 14)(11, SocialPage_div_11_div_17_ng_template_11_Template, 9, 0, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function SocialPage_div_11_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div")(1, "ion-segment", 25);
    \u0275\u0275listener("ionChange", function SocialPage_div_11_Template_ion_segment_ionChange_1_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onSegmentChange($event));
    });
    \u0275\u0275elementStart(2, "ion-segment-button", 26);
    \u0275\u0275element(3, "ion-icon", 27);
    \u0275\u0275elementStart(4, "ion-label");
    \u0275\u0275text(5, "Leaderboard");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "ion-segment-button", 28);
    \u0275\u0275element(7, "ion-icon", 29);
    \u0275\u0275elementStart(8, "ion-label");
    \u0275\u0275text(9, "Notifications");
    \u0275\u0275elementEnd();
    \u0275\u0275template(10, SocialPage_div_11_ion_badge_10_Template, 2, 1, "ion-badge", 30);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "ion-segment-button", 31);
    \u0275\u0275element(12, "ion-icon", 32);
    \u0275\u0275elementStart(13, "ion-label");
    \u0275\u0275text(14, "Friends");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(15, SocialPage_div_11_div_15_Template, 10, 3, "div", 33)(16, SocialPage_div_11_div_16_Template, 10, 5, "div", 34)(17, SocialPage_div_11_div_17_Template, 13, 6, "div", 35);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
