...
var routes = [
  ...
  {
    path: "social",
    loadComponent: () => import("./social.page-LLBJNZNO.js").then((m) => m.SocialPage),
    canActivate: [authGuard]
  },
  {
    path: "stocks",
    loadComponent: () => import("./stocks.page-SPD56RKO.js").then((m) => m.StocksPage),
    canActivate: [authGuard]
  },
  {
    path: "reset-password",
  ...
  {
    path: "weekly-receipt",
    loadComponent: () => import("./weekly-receipt.page-DF5OLEZQ.js").then((m) => m.WeeklyReceiptPage),
    canActivate: [authGuard]
  },
  {
    path: "**",
