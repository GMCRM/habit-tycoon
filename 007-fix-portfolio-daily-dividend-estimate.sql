-- MIGRATION 007: Fix per-holding dividend estimate in get_user_stock_portfolio
--
-- The daily_dividend_rate column was calculated without the GREATEST($0.01) floor,
